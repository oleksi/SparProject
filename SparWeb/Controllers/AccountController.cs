...
namespace SparWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
			: this(new UserManager<SparIdentityUser>(new SparIdentityUserStore<SparIdentityUser>()))
        {
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					...
					Fighter fighter = new Fighter() { Name = model.Name, Sex = model.Sex, DateOfBirth = dob, Height = model.Height, Weight = model.Weight, NumberOfFights = model.NumberOfFights, Gym = gleasonsGym };
        ...
        private async Task SignInAsync(SparIdentityUser user, bool isPersistent)
        {
